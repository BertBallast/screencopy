...
pub static MAX_AANTAL_FILES: Cell<i32>= Cell::new(9999);
...
pub static RANDONBEWERKT: Cell<usize> = Cell::new(1);
pub static RANDNABEWERKEN: Cell<usize> = Cell::new(0);
...
pub const HANDLEIDING_PIJLEN: [&str; 7] = [
    ...
    "verplaats zonodig het beeld met Positie-schuiuvers in Optiescherm\n",
    "verwijder deze handleiding met een muis-klik",
];
pub const BERICHT_MULTI_SIZE: [f32; 2] = [400.0, 300.0];
